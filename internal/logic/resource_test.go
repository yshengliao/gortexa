...
func TestResourceService_GetResource(t *testing.T) {
	...
	req1 := &resourcev1.CreateResourceRequest{Resource: &resourcev1.Resource{Name: "R1", Owner: "owner1"}}
...
func TestResourceService_DeleteResource(t *testing.T) {
	s, ctx, _ := setupTestService()
	res2, _ := s.CreateResource(ctx, &resourcev1.CreateResourceRequest{Resource: &resourcev1.Resource{Name: "R2", Owner: "owner2"}})
